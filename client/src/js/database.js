...
export const initdb = async () => {
  //were creating a new database named contact_db which will be using version 1 of the database.
  openDB("contact_Db", 1, {
...
export const getDb = async () => {
  ...
  const contact_Db = await openDB("contact_db", 1);

  // Create a new transaction and specify the store and data privileges.
  const tx = contact_Db.transaction("contacts", "readonly");
